				...
				<form class="d-flex" role="search">
					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0 bg-infor ">
						<li class="nav-item dropdown dropstart"><a
							class="nav-link dropdown-toggle" href="#" role="button"
							data-bs-toggle="dropdown" aria-expanded="false" style="color: blue;"> <%= khachHang.getTenkDangNhap()%> </a>
							<ul class="dropdown-menu">
								...
								<li><hr class="dropdown-divider"></li>
								<li><a class="dropdown-item" href="khach-hang-controller?hanhDong=dang-xuat&">Thoát tài khoản</a></li>
							</ul></li>
					</ul>		
					<%	} else { %>
					<a class ="btn btn-primary" style = "white-space: nowrap; margin-left: 10px;" href="login.jsp">Đăng nhập</a>
